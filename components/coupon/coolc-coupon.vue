<template>
	<view class="coupon-item">
		<view class="coupon-money">
			...
			<view class="end_time">{{end_time}}前使用</view>
			<view v-if="!types">
...
<script>
	export default {
		...
		computed: {
			end_time() {
				var riqi = new Date();
				var years = riqi.getFullYear();
				var months = ("0" + (riqi.getMonth() + 1)).slice(-2);
				var days = ("0" + (riqi.getDate() + 1)).slice(-2);
				var shijian = years + "年" + months + "月" + days + "日";
				return shijian
			}
		}
	}
